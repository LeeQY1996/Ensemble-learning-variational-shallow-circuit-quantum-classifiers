...
# statevector
export StateVector, DensityMatrix, distance, distance2, onehot_encoding, qubit_encoding, reset!, amplitude, amplitudes, StateVectorBatch, DensityMatrixBatch, nitems, CuStateVectorBatch, CuDensityMatrixBatch
...
# definitions of pure quantum state
include("statevector.jl")
include("statevectorbatch.jl")
include("custatevectorbatch.jl")

# definitions of pure quantum state batch (mainly used in quantum machine learning; maybe extend some function in the future.)

# density matrix representation 
include("densitymatrix.jl")
include("densitymatrixbatch.jl")
include("cudensitymatrixbatch.jl")
